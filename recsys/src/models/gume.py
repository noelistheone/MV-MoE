"""GUME (CIKM 2024) — ported faithfully into this training framework.

Graph-based and Uniform Modality Enhancement for multimodal recommendation.
Reference: Lin et al., CIKM 2024; official code vendored at
.sota_repos/GUME/src/models/gume.py.
