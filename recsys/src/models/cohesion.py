"""COHESION (SIGIR 2025) — ported faithfully into this training framework.

Source: .sota_repos/COHESION/src/models/cohesion.py (same author family as MENTOR /
DualGNN). Reported R@20 ~0.1052 / 0.1137 / 0.0983 (Baby / Sports / Clothing).
