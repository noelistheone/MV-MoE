"""DA-MRS (KDD 2024) — ported faithfully into this training framework.

Denoising and Aligning Multi-modal Recommender System.
Reference: Xv et al., KDD 2024; official MMRec-style implementation vendored at
.mmrec_ref/src/models/damrs.py.
